...
from proctweet import process_tweets_uc, get_absolute_paths
...
if __name__ == "__main__":
    start_time = time()
    n_read_files = 1442
    absolute_paths = get_absolute_paths("olympics-uc/", n_read_files)

    replies_to = process_tweets_uc(filter_is_reply, extract_in_reply_to, count_elements, {}, consolidate_counts, {},
                                absolute_paths)
    print(replies_to)
